...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm " style=" margin-left: 180px;">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            @if(auth()->user()->IsAdmin() or auth()->user()->isCreated() or auth()->user()->isEmployed() )

                                <a class="navbar-brand btn " href="{{route('GetAll')}}">
                                    New Purchase Order
                                </a>
        ...
        @auth
            <div class="container">
                ...
                @endif
                    <div class="sidebar" >
                            <li class="fa fa-fw fa-user-circle dropdown">
                        ...
                        @if(auth()->user()->IsAdmin() or auth()->user()->isCreated() or auth()->user()->isEmployed() )
                                    <li class="item">
                                        ...
                                        <a href="{{route('dashboard.company')}}"> <svg class="bi bi-house-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="fas fa-cart-plus">
                                        <a href="{{route('RequestItem.index')}}"> Requests</a>
                                    </li>
                            <li class="fas fa-cart-plus">
                                        <a href="{{route('order.index')}}"> <svg class="bi bi-envelope" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="fas fa-cart-plus">
                                        <a href="{{route('order.show')}}"><svg class="bi bi-geo" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="fas fa-cart-plus">
                                        <a href="{{route('invoice.index')}}"><svg class="bi bi-card-list" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="fas fa-cart-plus">
                                        <a href="{{route('invoice.show')}}"><svg class="bi bi-check-all" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="fas fa-cart-plus">
                                        <a href="{{route('companies.suppliers')}}"><svg class="bi bi-person-lines-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    @endif
                                    @if(auth()->user()->IsAdmin() or auth()->user()->isCreated() )
                            <li class="fas fa-cart-plus">
                                            <a href="{{route('users.index')}}"><svg class="bi bi-people" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    @endif
                            @if(auth()->user()->isSuppliers())
                            <li class="fas fa-cart-plus">
                                    <a href="{{route('dashboard.suppliers')}}"><svg class="bi bi-house-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" d="M8 3.293l6 6V13.5a1.5 1.5 0 01-1.5 1.5h-9A1.5 1.5 0 012 13.5V9.293l6-6zm5-.793V6l-2-2V2.5a.5.5 0 01.5-.5h1a.5.5 0 01.5.5z" clip-rule="evenodd"/>
                                            <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 011.414 0l6.647 6.646a.5.5 0 01-.708.708L8 2.207 1.354 8.854a.5.5 0 11-.708-.708L7.293 1.5z" clip-rule="evenodd"/>
                                        </svg>Dashboard</a>
                                </li>
                            <li class="fas fa-cart-plus">
                                    <a href="{{route('items.index')}}"><svg class="bi bi-file-plus" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="fas fa-cart-plus">
                                        <a href="{{route('RequestItem.show')}}"><svg class="bi bi-bell-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="fas fa-cart-plus">
                                        <a href="{{route('invoice.completed')}}"><svg class="bi bi-award-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="fas fa-cart-plus">
                                            <a href="{{route('users.AllUser')}}"> Users</a>
                                        </li>
                            <li class="fas fa-cart-plus">
                                            <a href="{{route('manager.AllItem')}}"> Items</a>
                                        </li>
                                        @endif
                        </ul>
                    </div>
