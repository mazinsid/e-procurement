...
<head>
    ...
    <!-- Google font -->
    <link href="{{asset('https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i&display=swap')}}" rel="stylesheet">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 p-3">
                <form class="hero-form"  method="POST" action="{{ route('register') }} ">
                    <a class="site-btn" href="{{ route('register') }}">{{ __('Register') }}</a><a href="{{ route('login') }}" class="site-btn">login</a>
